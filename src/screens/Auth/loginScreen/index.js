      ...
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        <View style={Style.mainView}>
          <View style={Style.headerView}>
            <Text style={Style.headerText}>Login Screen</Text>
          </View>
          <KeyboardAvoidingView style={{flex: 0.5}}>
            <View style={Style.containerView}>
              ...
              <TouchableOpacity
                ...
                <Text style={Style.loginText}>{constants.constants.Login}</Text>
              </TouchableOpacity>
            </View>
          </KeyboardAvoidingView>
          <View style={Style.bottomView}>
            <View style={Style.bottomContainerView}>
              <Text style={Style.dontText}>{constants.constants.Dont}</Text>
